...
export const SP_TEMPLATES: MockupTemplate[] = [
  ...
  { id: 'SP-mockup4-60x30',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_60x30.psd`,  sizeKey: '600x300',  outputName: 'product-60x30',  label: 'product 60x30 cm' },
  { id: 'SP-mockup4-60x40',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_60x40.psd`,  sizeKey: '600x400',  outputName: 'product-60x40',  label: 'product 60x40 cm' },
  { id: 'SP-mockup4-70x30',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_70x30.psd`,  sizeKey: '700x300',  outputName: 'product-70x30',  label: 'product 70x30 cm' },
  { id: 'SP-mockup4-70x50',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_70x50.psd`,  sizeKey: '700x500',  outputName: 'product-70x50',  label: 'product 70x50 cm' },
  { id: 'SP-mockup4-80x40',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_80x40.psd`,  sizeKey: '800x400',  outputName: 'product-80x40',  label: 'product 80x40 cm' },
  { id: 'SP-mockup4-80x55',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_80x55.psd`,  sizeKey: '800x550',  outputName: 'product-80x55',  label: 'product 80x55 cm' },
  { id: 'SP-mockup4-90x45',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_90x45.psd`,  sizeKey: '900x450',  outputName: 'product-90x45',  label: 'product 90x45 cm' },
  { id: 'SP-mockup4-90x60',  psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_90x60.psd`,  sizeKey: '900x600',  outputName: 'product-90x60',  label: 'product 90x60 cm' },
  { id: 'SP-mockup4-100x50', psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_100x50.psd`, sizeKey: '1000x500', outputName: 'product-100x50', label: 'product 100x50 cm' },
  { id: 'SP-mockup4-100x65', psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_100x65.psd`, sizeKey: '1000x650', outputName: 'product-100x65', label: 'product 100x65 cm' },
  { id: 'SP-mockup4-120x60', psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_120x60.psd`, sizeKey: '1200x600', outputName: 'product-120x60', label: 'product 120x60 cm' },
  { id: 'SP-mockup4-120x80', psdPath: `${BASE}/Mockups SP/Mockup_spatwand_1_120x80.psd`, sizeKey: '1200x800', outputName: 'product-120x80', label: 'product 120x80 cm' },
]
